...
const DeliveryFrom = ({ initialValues, handleForm2Submit, handleStepClick }: DeliveryFromProps) => {
  ...
  const handleSubmit = (values: FormDeliveryData) => {
    ...
    handleStepClick(3)
    console.log('data for delivery:', values);
  };
      ...
      {({ values, setFieldValue }) => (
        <Form className="p-4 bg-gray-100">
          <div className="mb-4">
            ...
            <Field as="select" id="region" name="region" className="form-select mt-1 block w-full p-2 border border-light-grey" onChange={(e: React.ChangeEvent<HTMLSelectElement>) => {
          ...
          <div className="mb-4">
            ...
            <Field as="select" id="city" name="city" className="form-select mt-1 block w-full p-2 border border-light-grey" onChange={(e: React.ChangeEvent<HTMLSelectElement>) => {
          ...
          <div className="mb-4">
            ...
            <Field as="select" id="postOffice" name="postOffice" className="form-select mt-1 block w-full p-2 border border-light-grey">
          ...
          <div className='flex justify-between p-[20px]'>
            <button className='bg-powder-pink px-7 py-2 text-md font-medium hover:bg-dark-grey hover:text-white focus:bg-dark-grey focus:text-white' onClick={() => handleStepClick(1)} >Назад</button>
